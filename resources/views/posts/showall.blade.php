...
<div class="container pb-5">
    ...
    <div class="row d-flex justify-content-center">
            ...
            <div class="col-8 mt-2">
                <div class="row">
                    <div class="col-3 d-flex">
                        <div class="">
                            <likebtn-component liked="{{(auth()->user()) ? (auth()->user()->liked->contains($post->id)) : false}}" post_id="{{$post->id}}"></likebtn-component>
                        </div>
                        <div class="ml-3 mt-2">
                    ...
                    <div class="col-4 d-flex">
                        <div>
                            <button onclick="showComments({{$post->id}})" class="btn btn-primary">Comments</button>
                        </div>
                        <div style="font-size: medium;" class="ml-2 mt-1">
        ...
        <div class="row d-flex flex-row justify-content-center mt-5">
            <div id="a{{$post->id}}" class="col-12 flex-column" style="display: none;">
                <div class="col-12 mx-0 px-0 py-4 mb-5" style="border-top: 1px solid lightgrey; border-bottom: 1px solid lightgrey;">
                    <form method="POST" action="/comment/{{ auth()->user()->id }}/{{$post->id}}">
                        @csrf
...
<script>
    ...
    function showComments(b){
        if (document.getElementById('a'+b).style.display == 'none') {
            document.getElementById('a'+b).style.display = 'flex'
        }else{
